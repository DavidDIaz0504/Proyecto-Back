        ...
        <section class="filter">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-3 col-sm-6 mb-4">
                        <button class="btnfilter">Ropa</button>
                    </div>
                    <div class="col-md-3 col-sm-6 mb-4">
                        <button class="btnfilter">Tecnología</button>
                    </div>
                    <div class="col-md-3 col-sm-6 mb-4">
                        <button class="btnfilter">Decoración</button>
                    </div>
                    <div class="col-md-3 col-sm-6 mb-4">
                        <button class="btnfilter">Belleza</button>
                    </div>
                </div>
            </div>
        </section>

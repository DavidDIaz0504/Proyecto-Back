...
<head>
    ...
    <title>Registro - ComicAnime Store</title>
    <!-- Bootstrap CSS -->
...
<body class="body">
    ...
    <div class="body">
        ...
        <form action="#" method="post" class="mt-4">
            ...
            <div class="mb-3">
                <label for="email" class="email-text">Correo</label>
        ...
        <div class="mt-3">
            <p class="no-have">¿Tienes cuenta? <a href="/register">Inicia Sesion</a></p>
        </div>
        <div class="mt-3">
            <p class="no-have">O Registrate con:</p>
